...
// @version  $State:$
// @date     $Date: 2013-04-08 17:48:08 +0100 (Mon, 08 Apr 2013) $
//
//*****************************************************************************/
 ...
 */
                           ...
                           uint32_t rx_en, uint32_t tx_irq_en, uint32_t rx_irq_en, uint32_t tx_ovrirq_en, uint32_t rx_ovrirq_en)
 {
       ...
       // TODO: by Sissy, for fast simualtion, only for uart0
       if (CMSDK_UART==CMSDK_UART0) {
           #ifdef REAL_BOOT
               new_ctrl &= ~CMSDK_UART_CTRL_HSTM_Msk;
           #else
               new_ctrl |= CMSDK_UART_CTRL_HSTM_Msk;
           #endif
       }
 ...
 */
 ...
 {
       // TODO: by Sissy, sync up with updated software/cmsis/Device/ARM/CMSDK_CM0plus/Include/CMSDK_CM0plus.h
       // return ((CMSDK_UART->INTSTATUS & CMSDK_UART_CTRL_TXIRQ_Msk)>>CMSDK_UART_CTRL_TXIRQ_Pos);
       return ((CMSDK_UART->INTSTATUS & CMSDK_UART_INTSTATUS_TXIRQ_Msk)>>CMSDK_UART_INTSTATUS_TXIRQ_Pos);
 }
 ...
 */
 ...
 uint32_t CMSDK_uart_GetRxIRQStatus(CMSDK_UART_TypeDef *CMSDK_UART)
 {
       ...
       return ((CMSDK_UART->INTSTATUS & CMSDK_UART_INTSTATUS_RXIRQ_Msk)>>CMSDK_UART_INTSTATUS_RXIRQ_Pos);
 }
 ...
 */
 ...
 void CMSDK_uart_ClearTxIRQ(CMSDK_UART_TypeDef *CMSDK_UART)
 {
       ...
       CMSDK_UART->INTCLEAR = CMSDK_UART_INTSTATUS_TXIRQ_Msk;
 }
 ...
 */
 ...
 void CMSDK_uart_ClearRxIRQ(CMSDK_UART_TypeDef *CMSDK_UART)
 {
       ...
       CMSDK_UART->INTCLEAR = CMSDK_UART_INTSTATUS_RXIRQ_Msk;
 }
